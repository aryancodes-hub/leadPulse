      ...
      <div className="client-bottom-grid">
        ...
        <div className="client-rounded-panel client-calls-card">
          ...
          <div className="client-panel-body">
            <span className="client-panel-big-number">{stats.totalCalls.toLocaleString()}</span>
            <span className="client-panel-subtext">Total calls placed across all sequences</span>
          </div>

          <div className="client-panel-footer">
            <div className="client-call-breakdown">
              <span className="client-stat-tag text-emerald-700 bg-emerald-50">84% Connected</span>
              <span className="client-stat-tag text-slate-700 bg-slate-100">Avg 3m 42s</span>
            </div>
          </div>
        </div>
        ...
        <div className="client-rounded-panel client-emails-card">
          ...
          <div className="client-panel-body">
            <span className="client-panel-big-number">{stats.totalEmails.toLocaleString()}</span>
          ...
          <div className="client-panel-footer">
            <div className="client-call-breakdown">
              <span className="client-stat-tag text-purple-700 bg-purple-50">48.2% Open rate</span>
        ...
        <div className="client-tall-campaigns-container">
          ...
          <div className="client-stacked-subpanels">
            ...
            <div className="client-stacked-box client-active-box">
              ...
              <span className="client-stacked-val text-emerald-600">{stats.activeCampaigns}</span>
            </div>
            ...
            <div className="client-stacked-box client-completed-box">
              ...
              <span className="client-stacked-val text-purple-600">{stats.completedCampaigns}</span>
            </div>
            ...
            <div className="client-stacked-box client-total-box">
              ...
              <span className="client-stacked-val text-slate-900">{stats.totalCampaigns}</span>
            </div>
          </div>
        </div>
      </div>
