...
export default function ExecutiveQueueView({ activeCampaign, perfData, refreshData }) {
    ...
    try {
      ...
      if (nextLeadData && nextLeadData.clientLead) {
        ...
        setCurrentLead({
          ...
          title: master.jobTitle || "N/A",
          industry: master.industry || "N/A",
  ...
  return (
    <div className="exec-queue-container">
      ...
      {!currentLead ? (
        <div className="p-10 mt-6 text-center text-lg font-bold text-slate-500 border-2 border-dashed border-slate-300 rounded-xl bg-slate-50">
          🎉 Queue is empty! No more pending leads.
        </div>
      ) : (
        <div className="exec-split-workspace mt-4">
          <div className="exec-workspace-card">
            ...
            <div className="exec-workspace-actions">
              <button type="button" onClick={handleSkipLead} disabled={isSkipping} className="exec-btn-skip-lead">
                <SkipForward size={16} />
          ...
          <div className="exec-workspace-card">
            ...
            <form onSubmit={handleSubmitAndNext} className="exec-form-body">
              {formError && (
                <div className="exec-form-error-alert">{formError}</div>
              )}
              ...
              <div className="exec-form-group">
                ...
                <select value={form.leadStatusUpdate} onChange={(e) => setForm({ ...form, leadStatusUpdate: e.target.value })} className="exec-select-input">
      ...
      <div className="exec-queue-progress-card mt-6">
        ...
        <div className="exec-progress-track">
          <div className="exec-progress-fill" style={{ width: `${progressPercent}%` }} />
        </div>
      </div>
    </div>
  );
