...
const FEATURES = [
    {
        ...
        description:
            "Build, approve, launch and monitor campaigns from one workspace.",
    },
    {
        mark: "\u25C9",
        title: "Lead intelligence",
        description:
            "Import lead lists, manage audiences and track every interaction.",
    },
    {
        mark: "\u2197",
        title: "Performance analytics",
        description:
            "Monitor calls, conversions, email engagement and campaign performance.",
    },
    {
        mark: "\u260E",
        title: "Calling & email in sync",
        description:
            "Every dial and every sequence step lands in the same lead timeline.",
    },
];
            ...
            >
                ...
                <div className="container main-section-inner">
                    <div className="main-copy">
                        ...
                        <h2>
                            Built for modern campaign teams.
                        </h2>
                        <p>
                            From the first lead import to the final conversion, Lead Pulse
                            keeps executives, campaign managers and clients looking at
                            the same numbers.
                        </p>
                    ...
                    <div className="signup-card">
                        ...
                        <p>
                            Your first account becomes the Campaign Manager for your agency.
                        </p>
                        {error && (
