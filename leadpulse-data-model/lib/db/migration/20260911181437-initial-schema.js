...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('users', {
      ...
      manager_id: { type: Sequelize.UUID, allowNull: true, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'SET NULL' },
      client_id: { type: Sequelize.UUID, allowNull: true, references: { model: 'clients', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'SET NULL' },
    ...
    await queryInterface.createTable('lead_lists', {
      id: { type: Sequelize.UUID, defaultValue: Sequelize.UUIDV4, primaryKey: true },
      client_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'clients', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      name: { type: Sequelize.STRING, allowNull: false },
      imported_by_user_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      created_at: { type: Sequelize.DATE, allowNull: false },
      updated_at: { type: Sequelize.DATE, allowNull: false }
    });
    ...
    await queryInterface.createTable('import_jobs', {
      id: { type: Sequelize.UUID, defaultValue: Sequelize.UUIDV4, primaryKey: true },
      client_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'clients', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      lead_list_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'lead_lists', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      uploaded_by_user_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      s3_source_file_key: { type: Sequelize.STRING, allowNull: false },
      s3_error_file_key: { type: Sequelize.STRING, allowNull: true },
      status: { type: Sequelize.ENUM("Uploaded", "Queued", "Processing", "Completed", "Completed_with_Errors", "Failed"), defaultValue: "Uploaded" },
    ...
    await queryInterface.createTable('client_leads', {
      id: { type: Sequelize.UUID, defaultValue: Sequelize.UUIDV4, primaryKey: true },
      client_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'clients', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      master_contact_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'master_contacts', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
    ...
    await queryInterface.createTable('lead_list_memberships', {
      id: { type: Sequelize.UUID, defaultValue: Sequelize.UUIDV4, primaryKey: true },
      lead_list_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'lead_lists', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      client_lead_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'client_leads', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      status: { type: Sequelize.ENUM("Pending", "Converted", "Dead", "Callback", "Unreachable"), defaultValue: "Pending" },
    ...
    await queryInterface.createTable('campaigns', {
      ...
      client_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'clients', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      lead_list_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'lead_lists', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      sequence_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'sequences', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      requires_net_new_leads: { type: Sequelize.BOOLEAN, defaultValue: false },
      created_by_user_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      name: { type: Sequelize.STRING, allowNull: false },
      type: { type: Sequelize.ENUM("email", "call"), allowNull: false },
      description: { type: Sequelize.TEXT, allowNull: true },
      category_tag: { type: Sequelize.STRING, allowNull: true },
      status: { type: Sequelize.ENUM("draft", "active", "paused", "completed"), defaultValue: "draft" },
      dispatch_status: { type: Sequelize.ENUM("not_sent", "sending", "sent"), defaultValue: "not_sent" },
      ...
      approved_by_user_id: { type: Sequelize.UUID, allowNull: true, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'SET NULL' },
    ...
    await queryInterface.createTable('campaign_executives', {
      ...
      executive_user_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      is_active: { type: Sequelize.BOOLEAN, defaultValue: true },
    ...
    await queryInterface.createTable('campaign_leads', {
      ...
      campaign_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'campaigns', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      client_lead_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'client_leads', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      assigned_executive_id: { type: Sequelize.UUID, allowNull: true, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'SET NULL' },
      assigned_at: { type: Sequelize.DATE, allowNull: true },`n        status: { type: Sequelize.ENUM("pending", "in_progress", "called", "skipped", "completed"), defaultValue: "pending" },`n        status_updated_at: { type: Sequelize.DATE, allowNull: true },`n        created_at: { type: Sequelize.DATE, allowNull: false },`n        updated_at: { type: Sequelize.DATE, allowNull: false }
    });
    ...
    await queryInterface.createTable('lead_engagements', {
      ...
      status: { type: Sequelize.ENUM("sent", "delivered", "bounced", "spamreport"), defaultValue: "sent" },
    ...
    await queryInterface.createTable('call_remarks', {
      ...
      client_lead_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'client_leads', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      executive_user_id: { type: Sequelize.UUID, allowNull: false, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'CASCADE' },
      call_outcome: { type: Sequelize.ENUM("Answered", "Not_Answered", "Busy", "Wrong_Number", "Left_Voicemail", "Callback_Requested", "Not_Interested", "Converted"), allowNull: false },
      ...
      lead_status_update: { type: Sequelize.ENUM("New", "Contacted", "Qualified", "Converted", "Dead"), allowNull: true },
      ...
      confirmed_by_user_id: { type: Sequelize.UUID, allowNull: true, references: { model: 'users', key: 'id' }, onUpdate: 'CASCADE', onDelete: 'SET NULL' },
